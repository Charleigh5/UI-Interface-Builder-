...
const ICONS: Record<IconName, React.FC<React.SVGProps<SVGSVGElement>>> = {
    ...
    input: (props) => (
        <svg {...props} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            <path d="M4 12.5v-6a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v11a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2v-2.5" />
            <path d="M12 16h6" />
        </svg>
    ),
    image: (props) => (
    ...
    ungroup: (props) => (
        <svg {...props} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            <path d="M5.5 8.5L9 12l-3.5 3.5M18.5 8.5L15 12l3.5 3.5" />
            <path d="M14 12H9" />
            <rect x="3" y="3" width="18" height="18" rx="2" />
        </svg>
    ),
    'bring-to-front': (props) => (
        <svg {...props} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    ...
    'send-to-back': (props) => (
        <svg {...props} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            ...
            <path d="M8 20V8a2 2 0 0 1 2-2h10" />
        </svg>
    ),
    'align-left': (props) => (
        <svg {...props} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
