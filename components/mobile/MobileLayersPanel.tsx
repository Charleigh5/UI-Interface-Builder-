 ...
 */
export const MobileLayersPanel: React.FC<MobileLayersPanelProps> = ({
  isVisible,
  onClose,
}) => {
  const {
  ...
  const handleUpdate = useCallback(
    (id: string) => (updates: Partial<WireframeComponent>) => {
        ...
        <div className="flex items-center space-x-2 flex-shrink-0">
          <button
            ...
            className={`
                    ...
                    `}
            aria-label={
              component.isLocked ? "Unlock component" : "Lock component"
            }
          >
            <Icon
